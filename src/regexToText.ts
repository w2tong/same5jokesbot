...
const regexToText = [
	...
	},
	{
		regex: /166/,
		getText: () =>
			'https://media.discordapp.net/attachments/158049091434184705/795546735594045450/unknown.png',
	},
	{
		regex: /judge?ment/,
		getText: () =>
			'https://media.discordapp.net/attachments/837434910486691873/1008836841581072454/judgment.png',
	},
	// {
	//     regex: /shut.*up/,
	//     getText: () => 'Smosh voice.'
