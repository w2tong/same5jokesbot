...
const slotsSymbols: {[key: string]: SlotsSymbol} = {
    ...
    vacation:       {pc: 0.6, mult: 5.5, emote: Emotes.vacation, backupEmote: ''},
    borpaSpin:      {pc: 0.8, mult: 6, emote: Emotes.borpaSpin, backupEmote: ''},
    ChugU:          {pc: 1, mult: 7, emote: Emotes.ChugU, backupEmote: ''}
};
...
const symbols = [
    ...
    ...repeatSymbolArray(slotsSymbols.gachiBASS, 7),
    ...repeatSymbolArray(slotsSymbols.THIS, 6),
