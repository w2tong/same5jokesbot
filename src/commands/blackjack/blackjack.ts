...
async function execute(interaction: ChatInputCommandInteraction) {
    ...
    const blackjack = new BlackjackGame(interaction.user.id, interaction.user.username, numOfDecks, wager, balance, interaction.client.channels, interaction.channelId);
